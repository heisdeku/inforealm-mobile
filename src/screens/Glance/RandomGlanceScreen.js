...
const LatestGlanceScreen = () => {
    ...
    const loadMoreRandomNewsByCategory = async () => {
        try {
                        ...
                        <View style={styles.body}>
                            <View style={styles.category}>
                                <View style={styles.categoryItems}>
                                    ...
                                    data={news}
                                    keyExtractor={item => `GlanceRandom-${category_id}-${item.id.toString()}-${Math.floor(Math.random() * 10000)}`}
                                    renderItem={({item}) => {
                                        return(
                                    ...
                                    onEndReached={() => loadMoreRandomNewsByCategory()}
